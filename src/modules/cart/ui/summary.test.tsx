  ...
  return (
    <>
      <button
        type="button"
        onClick={() =>
          dispatch({ type: "add", productId: 101, variantId: 201, price: PRICE, quantity: 3, limit: null })
        }
      >
        seed
      </button>
...
describe("CartSummary", () => {
  it("labels the transfer total as Subtotal, keeps Total the same figure, and drops the discount amount", () => {
    ...
    expect(screen.getByText("ya incluye 10% off por transferencia")).not.toBeNull();
